<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/1.master" AutoEventWireup="true" CodeFile="AddPhotos.aspx.cs" Inherits="Admin_Default" %>
              ...
              <form>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <%--<input type="text" id="firstname" class="form-control">--%>
                      <asp:Image ID="Image1" class="avatar-img rounded-circle" Height="300px" Width="300px"  runat="server" />
                  </div>
                  </div>
