<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/1.master" AutoEventWireup="true" CodeFile="Trainer_Invoice.aspx.cs" Inherits="Admin_Default" %>
        ...
        <div class="row">
			...
			<div class="col-md-12 text-left mb-3">
                <h2 class="h5 page-title"><small class="text-muted text-uppercase">Invoice</small><br />
                    #<asp:Label ID="lbl_trainer_paid_id" runat="server" Text=""></asp:Label></h2>
            </div>
            ...
            <div class="card shadow">
				...
				<div class="row mb-5">
                    ...
                    <div class="col-md-5">
                      ...
                      <p class="mb-4">
                        <strong>
                            ...
                            <asp:Label ID="lbl_lname" runat="server" Text=""></asp:Label></asp:Label>
                            </strong><br />
                        ...
                        <table class="table table-lg">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <h6 class="mb-0">
                                            <asp:Label ID="lbl_plan_name" runat="server" Text=""></asp:Label> Personal Trainer. (PT : <asp:Label ID="lbl_trainer_name" runat="server" Text="Label"></asp:Label>) 
                                            </h6> <span class="text-muted">Expiry Date : 
                    ...
                    <div class="card-body">
                     ...
                     <h6 class="mb-0">
                    Welcome To KG FITNESS . You Paid By <asp:Label ID="lbl_payment_method" runat="server" Text=""></asp:Label></h6> 
                </div>
