<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/1.master" AutoEventWireup="true" CodeFile="AcceptPayment.aspx.cs" Inherits="Admin_Default" %>
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                         ...
                         <tr>
                            ...
                            <td>
                                ...
                                <asp:LinkButton ID="LinkButton1" class="btn mb-2 btn-outline-success" visible='<%# Convert.ToString(Eval("payment_method")).Equals("CASH") ? Convert.ToInt32(Eval("status")).Equals(0) ? true: false : false %>' PostBackUrl='<%# "AcceptPaid.aspx?mpid=" + Eval("membership_paid_id") %>' runat="server">Accept</asp:LinkButton><asp:LinkButton
                      ...
                      <%-- <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT * FROM [Membership_Paid]"></asp:SqlDataSource>
