...
public partial class Trainer_ForgotPassword : System.Web.UI.Page
{
    ...
    {
         cn.Open();
        qry = "select * from Trainer where email='" + Txt_Email.Text + "'";
        ...
        if (dr.HasRows)
        {
            ...
            Response.Redirect("~/Trainer/ConfirmPassword.aspx");
        }
        else
        {
