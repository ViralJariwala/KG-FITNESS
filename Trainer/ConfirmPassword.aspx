<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmPassword.aspx.cs" Inherits="Trainer_ConfirmPassword" %>
      ...
      <div class="row align-items-center h-100">
        <form id="Form1" class="col-lg-3 col-md-4 col-10 mx-auto text-center" runat="server">
          <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="">
           ...
           <h4 class="my-3">Forgot Password Successfully!</h4>
           <div class="alert alert-success" role="alert"> An email has been sent to your email <strong><%=Session["email"].ToString() %></strong>. Please check your email to get password </div>
