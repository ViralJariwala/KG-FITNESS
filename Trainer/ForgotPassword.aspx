<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ForgotPassword.aspx.cs" Inherits="Trainer_ForgotPassword" %>
    ...
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form id="Form1" class="col-lg-3 col-md-4 col-10 mx-auto text-center" runat="server">
          <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="">
           ...
           <h2 class="my-3">Forgot Password</h2>
            <p class="text-muted">Enter your email address and we'll send you an email to reset your password</p>
        ...
        <asp:Button ID="Btn_submit" class="btn btn-lg btn-primary btn-block" 
              runat="server" Text="Forgot Password" onclick="Btn_submit_Click"  />

        <asp:Label ID="Label1" class="mt-5 mb-3 text-muted" runat="server" ></asp:Label>
