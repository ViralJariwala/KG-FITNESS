...
public partial class Trainer_SignUp : System.Web.UI.Page
{
    ...
    protected void btn_signup_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        qry = "insert into trainer values('" + txt_name.Text + "','" + txt_address.Text + "','" + txt_email.Text + "','" + txt_password.Text + "','" + ddl_gender.SelectedItem.Value + "','" + txt_phone_no.Text + "','" + ddl_specialities.SelectedItem.Value + "','" + ddl_Experience.SelectedItem.Value + "','" + txt_weight.Text + "','" + txt_age.Text + "','" + fname + "',0)";
