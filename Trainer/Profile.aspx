<%@ Page Title="" Language="C#" MasterPageFile="~/Trainer/Trainer.master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="Trainer_Default" %>
                ...
                <div class="col">
                  ...
                  <div class="row mb-4">
                    <div class="col-md-7">
                      ...
                      <p>Email Id : <%#Eval("email") %></p>
                      <p>Gender : <%#Eval("gender") %></p>
                      <p>Mobile No : <%#Eval("mobile") %></p>
                      <p>Experience : <%#Eval("expericence") %></p>
                    ...
                    <a class="btn mb-2 btn-outline-secondary" href='EditProfile.aspx?tid=<%= Session["tid"].ToString()%>'>Edit Changes</a>
