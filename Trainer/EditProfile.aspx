<%@ Page Title="" Language="C#" MasterPageFile="~/Trainer/Trainer.master" AutoEventWireup="true" CodeFile="EditProfile.aspx.cs" Inherits="Trainer_Default" %>
            ...
            <div class="col-12 col-lg-10 col-xl-8">
              ...
              <div class="my-4">
               <%-- <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="Profile.aspx" role="tab" aria-controls="home" aria-selected="true">Profile</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="Profile.aspx" role="tab" aria-controls="profile" aria-selected="false">Security</a>
                  </li>
                  <li class="nav-item">
                    ...
                    <div class="col">
                      <div class="row align-items-center">
                        <div class="col-md-7">
                          ...
                          <p class="small mb-3"><span class="badge badge-dark"><%#Eval("specialities") %></span></p>
