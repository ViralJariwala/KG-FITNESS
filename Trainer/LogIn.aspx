<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogIn.aspx.cs" Inherits="Trainer_LogIn" %>
      ...
      <div class="row align-items-center h-100">
        <form id="Form1" class="col-lg-3 col-md-4 col-10 mx-auto text-center" runat="server">
          <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="">
           ...
           <h2 class="my-3">Trainer Login</h2>
          ...
          <div class="form-group">
           ...
           <div>
             <br /><asp:HyperLink ID="HyperLink2" class="card-text" runat="server" NavigateUrl="~/Trainer/ForgotPassword.aspx">Forgot Password</asp:HyperLink><br />
             </div>

          <%--<button class="btn btn-lg btn-primary btn-block" type="submit">Let me in</button>--%>
       <br /> <asp:Button ID="Btn_submit" class="btn btn-lg btn-primary btn-block" 
              runat="server" Text="Let me in" onclick="Btn_submit_Click1"/>

              <p class="mt-5 mb-3 text-muted"></p>

          <asp:HyperLink ID="HyperLink1" class="card-text" runat="server" NavigateUrl="~/Trainer/SignUp.aspx">Trainer Sign Up</asp:HyperLink> 
        </form>
