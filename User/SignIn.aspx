                        ...
                        <form runat="server">
                            <div class="form-group text-left">
                                ...
                                <%--<input type="email" class="form-control" id="email" placeholder="xyz@gmail.com">--%>
                                 <asp:TextBox ID="txt_email" class="form-control" placeholder="xyz@gmail.com" runat="server" TextMode="Email" required="true"></asp:TextBox>
                            </div>
                            <div class="form-group text-left">
                               ...
                               <asp:TextBox ID="txt_password" class="form-control" placeholder="Enter Password" runat="server" TextMode="Password" required="true"></asp:TextBox>
                            </div>
                            <a href="ForgotPassword.aspx">Forgot Password</a>


                            <%--<a class="btn btn-success btn-lg btn-block">Login</a>--%>
                        <asp:Button ID="btn_signin" class="btn btn-success btn-lg btn-block" runat="server" 
                                Text="Login" onclick="btn_signin_Click" />

                                 <p>By joining, you agree to the <a href="#">Terms</a> and <a href="#">Privacy Policy</a>.</p><br />

                                 <p>Are You Admin?<a href="../Admin/LogIn.aspx"> Click Here</a></p>
                                  <p>Are You Trainer?<a href="../Trainer/LogIn.aspx"> Click Here</a></p><br /><br /><br />
