<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="UHome.aspx.cs" Inherits="User_Default" %>
                            ...
                            <div class="about-content">
                               ...
                               <iframe frameborder="0" src="../HTMLPages/AboutUS.htm" height="800" width="900"></iframe>
                                <div class="btn-wrapper margin-top-40">
                                    <a href="AboutUs.aspx" class="btn btn-element btn-normal-size btn-main-color btn-rounded mr-5">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="explore-title">
                        ...
                        <div class="btn-wrapper">
                            <a href="MembershipPricing.aspx" class="btn btn-element btn-lg btn-main">Join with us</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="content d-flex ">
                                ...
                                <div class="thumb align-self-end">
                                    ...
                                    <%--<asp:Image ID="Image1" ImageUrl='<%#Eval("image") %>' Height="200px" Width="200px" runat="server" />--%>
                                </div>
                            </div>
                        </div>
                    </div>
