<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="TrainerPlanPricing.aspx.cs" Inherits="User_Default" %>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-pricing-style-01 pricing-item-bg3">
                        ...
                        <div class="btn-wrapper desktop-center">
                           <a href='TrainerPlanPurchase.aspx?tpid=<%#Eval("trainer_plan_id") %>&tid=<%#Eval("trainer_id") %>&plan_name=<%#Eval("plan_name") %>&price=<%#Eval("price") %>&discount=<%#Eval("discount") %>'class="btn btn-element btn-normal-size btn-transparent-color btn-rounded">Select Plan</a>
