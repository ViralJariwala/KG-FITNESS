<%@ Page Title="" Language="C#" MasterPageFile="~/User/Visitor.master" AutoEventWireup="true" CodeFile="TrainerVS.aspx.cs" Inherits="User_Default" %>
                        ...
                        <div class="col-md-7 d-flex align-items-center">
                            <div class="content">
                                ...
                                <div class="btn-wrapper">
                                    <a href="TrainerPlanPricingVS.aspx?tid=<%#Eval("trainer_id") %>" class="btn btn-element btn-normal-size btn-transparent-color btn-rounded">Book Trainer</a>
                                </div>
