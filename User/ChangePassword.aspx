                        ...
                        <div class="col-md-7 d-flex align-items-center">
                            <div class="content">
                               <%-- <h3><%#Eval("fname") %> <%#Eval("lname") %></h3>
                                ...
                                <h5>Old Password : </h5> <br /> <asp:TextBox ID="txt_password" 
                                    class="form-control" placeholder="Enter Old Password" runat="server" 
                                    required="true" TextMode="Password"></asp:TextBox><br />
                                <h5>New Password : </h5> <br /> <asp:TextBox ID="txt_new_password" 
                                    class="form-control" placeholder="Enter New Password" runat="server" 
                                    required="true" TextMode="Password"></asp:TextBox><br />
                                <h5>Confirm New Password : </h5> <br /> <asp:TextBox ID="txt_confirm_password" 
                                    class="form-control" placeholder="Enter Confirm Password" runat="server" 
                                    required="true" TextMode="Password"></asp:TextBox><br />
                                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                    ErrorMessage="Password Not Match" ControlToCompare="txt_new_password" 
