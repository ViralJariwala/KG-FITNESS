...
public partial class User_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cn.Open();
        qry = "insert into Trainer_Invoice values('" + member_id + "','" + trainer_paid_id + "','" + trainer_name +"','" + fname + "','" + lname + "','" + email + "','" + address + "','" + mobile + "','" + DateTime.Now.ToString("dd-MM-yyyy") + "','" + plan_name + "','" + price + "','" + discount + "','" + sub_total + "','" + sgst + "','" + cgst + "','" + total_amount + "','TRAINER','" + expiry_date + "',0)";
        cmd = new SqlCommand(qry, cn);
        cmd.ExecuteNonQuery();
        cn.Close();
        ...
        Response.Redirect("UHome.aspx?Trainer=invalid");
