<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmPassword.aspx.cs" Inherits="User_ConfirmPassword" %>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="sign-content signup-content text-center h-100">
                       <div class="thumb">
                        ...
                        <h3>Forgot Password Successfully!</h3>
                         <p>An email has been sent to your email <strong><%=Session["email"].ToString() %></strong> Please check your email to get password</p>
                        ...
                        <asp:Button ID="btn_confirm" class="btn btn-success btn-lg btn-block" runat="server" 
                                Text="Back To LogIn" onclick="btn_forgot_Click" />
